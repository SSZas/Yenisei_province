...
for image in os.listdir(folder_dir + "\\" + "01color"):
    ...
    for line in range(0, int(len(list_start_end_1)), 2):
        ...
        if count_lines < 10:
            cv2.imwrite(folder_dir + "\\" + "final_lines" + "\\" + "line000" + str(count_lines) + ".tif", croped)
        elif count_lines < 100:
            cv2.imwrite(folder_dir + "\\" + "final_lines" + "\\" + "line00" + str(count_lines) + ".tif", croped)
        elif count_lines < 1000:
            cv2.imwrite(folder_dir + "\\" + "final_lines" + "\\" + "line0" + str(count_lines) + ".tif", croped)
